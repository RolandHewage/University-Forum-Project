<?php
	...
	if(empty($r3)){
		...
		if(mysqli_query($conn,$q4)){
			...
			$s2="insert into user(user_name,password,role,email,birth_date) values('admin2','admin2123','administrator','admin2@gmail.com','1977-7-3')";
	...
	if(empty($r10)){
		...
		$q12="insert into new_notice(user_id,notice,submit_date,submit_time) values(1,'Dora treanding part eka ivara karapn!!','2017:12:5','11:21:AM')";
		$q13="insert into new_notice(user_id,notice,submit_date,submit_time) values(1,'Roland meke decaration tika karala dipn!!','2017:12:5','11:21:AM')";
		$q14="insert into new_notice(user_id,notice,submit_date,submit_time) values(1,'Sela ubage veda tikath ikmanata karapn yakuuuuu!!','2017:12:5','11:21:AM')";
