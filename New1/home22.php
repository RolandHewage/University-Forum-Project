    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="home22.php">UORForum</a>
            </div>
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="home22.php"><span class="glyphicon glyphicon-home"></span> HOME</a></li>
                    <li><a href="question.php"><span class="glyphicon glyphicon-question-sign"></span> SUBMIT_QUESTION</a></li>

                    <?php
                        if($role=="administrator"){ ?>
                            <li><a href="notice.php"><span class="glyphicon glyphicon-envelope"></span> ENTER_NEW_NOTICE</a></li>
                        
                        <?php  }
                    ?>

                    <li><a href="user_profile.php?u_id=$user_id"><span class="glyphicon glyphicon-user"></span> PROFILE</a></li>
                    <li><a href="logout.php"><span class="glyphicon glyphicon-log-out"></span> SIGN_OUT</a></li>      
                </ul>
                <!--
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-6 text-center">
                ...
                <div class='well'> 
                    <form class='form-horizontal'  method='post' action='home22.php'>
                    <h4 align='left'>What's your question today? Let's discuss!</h4>
                    <div class='form-group' style='padding:14px;'>
                        ...
                        <textarea class='form-control' rows='4' placeholder='Update your status' name='content'></textarea>
                    </div>
                    <div class='mypink2'>
                    <button class='btn btn-primary pull-right' name='addpost'>Post</button>
                    <ul class='list-inline'><li><a href=''><i class='glyphicon glyphicon-upload'>
                    </i></a></li><li><a href=''><i class='lyphicon glyphicon-camera'>
                    </i></a></li><li><a href=''><i class='glyphicon glyphicon-map-marker'>
                    </i></a></li></ul>
                    </div>
                    </form>
                    <?php insertpost($id);?>
                    <ul class="pagination mypink">
                        <li><a href="home22.php?page=1">1</a></li>
                        <li><a href="home22.php?page=2">2</a></li>
                        <li><a href="home22.php?page=3">3</a></li>
                        <li><a href="home22.php?page=4">4</a></li>
                        <li><a href="home22.php?page=5">5</a></li>
                    </ul>
                </div>
                <?php  
                        ...
                        for ($i=0; $i < 5; $i++) { 
                            ...
                            if(!empty($num_rows1)){
                                ...
                                echo "<div class='panel-body'>";
                                    ...
                                    echo "
                                        <br>
                                        <a href='single.php?post_id=$maxindex[$i]' class='btn btn-primary' style='float:right'>SEE</a>
                                    </form>
                                </div>
                                ";
