...
<body>
    ...
    <div class="container jumbotron">
        ...
        <?php
			if($role=="student"){ ?>
        <div class="col-sm-12">  
            <p class="text-center"><a href="mentor_data.php?name=mentor">[ View Mentor ]</a><a href="user_profile.php">[ Home ]</a></p>
        </div>
        <?php	}  ?>
	    ...
	    //===================add new addminitore=============(only for adminitratotrss)================
		    ...
		    if($_SERVER['REQUEST_METHOD']=="POST"){
			    if(isset($_POST['add_user'])){ ?>
					<form class="form-horizontal" action="user_profile.php" name="f4" method="post">
                        <div class="form-group">
